...
newhp$Voltage <- as.numeric(as.character(newhp$Voltage))
newhp$Global_reactive_power <- as.numeric(as.character(newhp$Global_reactive_power))
...
with(newhp, {
        ...
        plot(date_time, newhp$Voltage,xlab = "datetime",
             ylab = "Voltage", type = "l")
        ...
        legend("topright", legend = c("Sub_metering_1", "Sub_metering_2",
                                      "Sub_metering_3"),
               lwd=c(1,1,1),col=c("black", "red", "blue"),bty="n", cex=0.5)
        
        
        plot(date_time, newhp$Global_reactive_power,xlab = "datetime",
